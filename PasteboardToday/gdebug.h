...
@end
        ...
        #define DLOG_PREFIX__(prefix) #prefix
        #define DLOG_PREFIX_(prefix) DLOG_PREFIX__(prefix)
        #define PRE DLOG_PREFIX_(DLOG_PREFIX)
...
#pragma mark - Time Logging Methods
        ...
        #define DLogTimeInterval(val)           DLogNSTimeInterval(val)
        #define DLogNSTimeInterval(val)         NSLog(@"%s:%s;%f;", PRE, #val, val)
